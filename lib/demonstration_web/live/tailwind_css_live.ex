defmodule DemonstrationWeb.TailwindCSSLive do
  ...
  @components ~w(list_1 table_1 form_1 button_1 fieldset_1 drag_and_drop_list_1 doughnut_chart_1 line_chart_1 file_uploader_1 range_1 selectable_cards_1 signup_form_1 card_1)
  ...
  def render(assigns) do
    ...
    <div class="relative">
      ...
      <div class="flex flex-col items-center justify-center">
        ...
        <.signup_form_1 :if={@component == "signup_form_1"} />
        <.card_1 :if={@component == "card_1"} />
      </div>
      <button
        phx-click="next"
  ...
  defp signup_form_1(assigns) do
    ~H"""

    """
  end

  defp card_1(assigns) do
    ~H"""
      ...
      <div class="md:flex">
        <div class="md:shrink-0">
          <img
            ...
            src="https://images.unsplash.com/photo-1487958449943-2429e8be8625?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2670&q=80"
