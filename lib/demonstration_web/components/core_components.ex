defmodule DemonstrationWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(DemonstrationWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(DemonstrationWeb.Gettext, "errors", msg, opts)
    end
  end
